...
<cfcomponent extends="org.puremvc.cf.patterns.command.MacroCommand"
	...
	<cffunction name="initializeMacroCommand" returntype="void" access="public" output="true">
		<cfscript>
			this.addSubCommand("ModelPrepCommand", "HelloWorldAjax.controller.ModelPrepCommand" );
            this.addSubCommand("ViewPrepCommand", "HelloWorldAjax.controller.ViewPrepCommand" );
		</cfscript>
	</cffunction>
