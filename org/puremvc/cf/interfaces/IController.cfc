...
<cfinterface displayname="IController"
	...
	<cffunction name="registerCommand" returntype="void" access="public" output="false" hint="Register a particular ICommand class as the handler for a particular INotification.">
	...
	<cffunction name="executeCommand" returntype="void" access="public" output="false" hint="Execute the ICommand previously registered as the handler for INotifications with the given notification name.">
